...
public class ItemRegistry {
    ...
    //region spirits
    public static final RegistryObject<SpiritShardItem> SACRED_SPIRIT = ITEMS.register("sacred_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.SACRED.get()));
    public static final RegistryObject<SpiritShardItem> WICKED_SPIRIT = ITEMS.register("wicked_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.WICKED.get()));
    public static final RegistryObject<SpiritShardItem> ARCANE_SPIRIT = ITEMS.register("arcane_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.ARCANE.get()));
    public static final RegistryObject<SpiritShardItem> ELDRITCH_SPIRIT = ITEMS.register("eldritch_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.ELDRITCH.get()));
    public static final RegistryObject<SpiritShardItem> AQUEOUS_SPIRIT = ITEMS.register("aqueous_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.AQUEOUS.get()));
    public static final RegistryObject<SpiritShardItem> AERIAL_SPIRIT = ITEMS.register("aerial_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.AERIAL.get()));
    public static final RegistryObject<SpiritShardItem> INFERNAL_SPIRIT = ITEMS.register("infernal_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.INFERNAL.get()));
    public static final RegistryObject<SpiritShardItem> EARTHEN_SPIRIT = ITEMS.register("earthen_spirit", () -> new SpiritShardItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.EARTHEN.get()));
    //endregion
    ...
    public static final RegistryObject<Item> ATTUNED_OPTIC_AERIAL = ITEMS.register("aerial_tuned_optic", () -> new TunedOpticItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.AERIAL.get()));
    public static final RegistryObject<Item> ATTUNED_OPTIC_AQUEOUS = ITEMS.register("aqueous_tuned_optic", () -> new TunedOpticItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.AQUEOUS.get()));
    public static final RegistryObject<Item> ATTUNED_OPTIC_INFERNAL = ITEMS.register("infernal_tuned_optic", () -> new TunedOpticItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.INFERNAL.get()));
    public static final RegistryObject<Item> ATTUNED_OPTIC_EARTHEN = ITEMS.register("earthen_tuned_optic", () -> new TunedOpticItem(DEFAULT_PROPERTIES(), SpiritTypeRegistry.EARTHEN.get()));
