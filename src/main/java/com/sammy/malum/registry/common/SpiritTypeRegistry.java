...
public static int getIndexForSpiritType(MalumSpiritType type) {
    ...
    public static MalumSpiritType get(String type) {
    MalumSpiritType malumSpiritType = SACRED_SPIRIT.get();
        for(RegistryObject<MalumSpiritType> spiritTypeRegistryObject : SPIRITS.getEntries()){
            if (spiritTypeRegistryObject.getId().getPath().equals(type)){
                malumSpiritType = spiritTypeRegistryObject.get();
            } else {
                malumSpiritType = SACRED_SPIRIT.get();
            }
        }
